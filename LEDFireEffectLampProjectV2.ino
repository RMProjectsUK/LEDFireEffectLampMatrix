...
#define NUM_LEDS    150                         // How many leds total?
...
const uint8_t MATRIX_WIDTH = 5;                   // Edit this to your matrix width
...
bool autoplayEnabled = true;                                          // Disable / Enable automatic play function
...
const PatternList patterns = {      // remove the // to enable extra patterns
 // analyzerColumns,
